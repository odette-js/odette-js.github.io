...
<pre class="code code-section" data-custom="code-snippet"><code class="language-javascript">// passing a function automatically initializes the module.
...
<pre class="code code-section" data-custom="code-snippet"><code class="language-javascript">scopedApp.run(function (app, _, factories) {
