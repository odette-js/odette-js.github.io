...
<pre class="code code-section"><code class="language-javascript">var $body = $('body');
...
<div id="members_isDocument">
    ...
    <pre class="code code-section"><code class="language-javascript">var manager = $(document).index(0);
...
<div id="members_isElement">
    ...
    <pre class="code code-section"><code class="language-javascript">var manager = $('body').index(0);
...
<div id="members_isFragment">
    ...
    <pre class="code code-section"><code class="language-javascript">var manager = $.fragment();
...
<div id="methods_$">
    ...
    <pre class="code code-section"><code class="language-javascript">var $divs = bodyManager.$('div'); // all the divs under body
...
<div id="methods_addValue">
    ...
    <pre class="code code-section"><code class="language-javascript">// &lt;body&gt;
...
<div id="methods_append">
    ...
    <pre class="code code-section"><code class="language-javascript">var newDiv = $.createElement('div');
...
<div id="methods_box">
    ...
    <pre class="code code-section"><code class="language-javascript">var boxModel = bodyManager.box();
// {
//     borderLeft: 0,
//     borderRight: 0,
//     borderTop: 0,
...
<div id="methods_changeValue">
    ...
    <pre class="code code-section"><code class="language-javascript">var specialManager = $('#unique-id').index(0);
...
<div id="methods_checked">
    ...
    <pre class="code code-section"><code class="language-javascript">// &lt;input type=&quot;checkbox&quot;/&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <pre class="code code-section"><code class="language-javascript">var topLevelManager = $('#top-level');
...
<div id="methods_classes">
    ...
    <pre class="code code-section"><code class="language-javascript">newDiv.classes('one two');
...
<div id="methods_client">
    ...
    <pre class="code code-section"><code class="language-javascript">bodyManager.client();
// {
//     top: 0,
//     left: 0,
//     right: 0,
...
<div id="methods_clone">
    ...
    <pre class="code code-section"><code class="language-javascript">newDivManager.clone();
// {
//     children: [],
//     attributes: {},
//     tagName: "div"
...
<div id="methods_contains">
    ...
    <pre class="code code-section"><code class="language-javascript">bodyManager.contains('div'); // true
...
<div id="methods_css">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.css('opacity', 0.5);</code></pre>
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.css({
    position: 'absolute',
    top: 0,
    right: 0,
    bottom: 0,
...
<div id="methods_data">
    ...
    <pre class="code code-section"><code class="language-javascript">newDivManager.data('wanted', 'alive'); // &lt;div data-wanted=&quot;alive&quot;&gt;&lt;/div&gt;</code></pre>
</div>
<div id="methods_destroy">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.destroy();</code></pre>
...
<div id="methods_disabled">
    ...
    <pre class="code code-section"><code class="language-javascript">var inputManager = $('input').index(0);
...
<div id="methods_dispatchEvent">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.on('click', function (e) {
...
<div id="methods_each">
    ...
    <pre class="code code-section"><code class="language-javascript">bodyManager.each(function (manager, index) {
...
<div id="methods_element">
    ...
    <pre class="code code-section"><code class="language-javascript">bodyManager.element(); // &lt;body&gt;&lt;/body&gt;</code></pre>
</div>
<div id="methods_elements">
    ...
    <pre class="code code-section"><code class="language-javascript">bodyManager.elements(); // [&lt;body&gt;&lt;/body&gt;]</code></pre>
</div>
<div id="methods_emit">
    ...
    <pre class="code code-section"><code class="language-javascript">$('iframe').index(0).emit('{"coded":"messages"}', 'http://odette-js.github.io', function (fake_evnt) {
...
<div id="methods_find">
    ...
    <pre class="code code-section"><code class="language-javascript">bodyManager.find(function (manager, index) {
    manager === bodyManager; // true
    index === 0; // true
    return !index;
...
<div id="methods_flow">
    ...
    <pre class="code code-section"><code class="language-javascript">bodyManager.flow();</code></pre>
</div>
<div id="methods_frame">
    ...
    <pre class="code code-section"><code class="language-javascript">bodyManager.frame('&lt;link rel=&quot;stylesheet&quot; href=&quot;/css/main.css&quot;&gt;', '&lt;div class=&quot;my-container&quot;&gt;&lt;/div&gt;');</code></pre>
...
<div id="methods_getAttribute">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.getAttribute('data-number'); // 5</code></pre>
</div>
<div id="methods_getStyle">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.getStyle('display'); // "block"</code></pre>
</div>
<div id="methods_hasValue">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.hasValue('dataList', 'two'); // true</code></pre>
</div>
<div id="methods_addClass">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.addClass('item1 class2');</code></pre>
</div>
<div id="methods_removeClass">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.removeClass('item1 class2');</code></pre>
</div>
<div id="methods_toggleClass">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.toggleClass('item1 class2');
...
<div id="methods_changeClass">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.changeClass('item1 class2', 'item3 item4');</code></pre>
...
<div id="methods_setClass">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.setClass('item1 class2'); // &lt;div class=&quot;item1 class2&quot;&gt;&lt;/div&gt;</code></pre>
</div>
<div id="hasClass">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.hasClass('item1 class2'); // false
...
<div id="methods_hasValue">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.hasValue('dataQuestionable', 'one'); // true</code></pre>
</div>
<div id="methods_hide">
    <h5 class="title-headline">#hide</h5>
    <p>The hide method is simply a convenience for setting display: none; on the element.</p>
    <pre class="code code-section"><code class="language-javascript">targetManager.hide(); // &lt;div style=&quot;display&colon; none;&quot;&gt;&lt;/div&gt;</code></pre>
</div>
<div id="methods_html">
    <h5 class="title-headline">#html</h5>
    <p>Use the html method to get and set the innerHTML of the target element.</p>
    <pre class="code code-section"><code class="language-javascript">targetElement.children().length(); // 0
...
<div id="methods_id">
    ...
    <pre class="code code-section"><code class="language-javascript">targetElement.id(); // false
...
<div id="methods_index">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.index(0); // targetManager</code></pre>
</div>
<div id="methods_insertAt">
    ...
    <pre class="code code-section"><code class="language-javascript">bodyManager.insertAt(divManager, 3); // inserts the div at the 4th child index</code></pre>
</div>
<div id="methods_length">
    ...
    <pre class="code code-section"><code class="language-javascript">bodyManager.length(); // 1</code></pre>
</div>
<div id="methods_next">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.next();</code></pre>
</div>
<div id="methods_off">
    <h5 class="title-headline">#off</h5>
    <p>Removes event handlers that match the parameters passed into the method.</p>
    <pre class="code code-section"><code class="language-javascript">var handleIt = function () {
    console.log('handled');
};
...
<div id="methods_on">
    ...
    <pre class="code code-section"><code class="language-javascript">bodyManager.on('evnt', function () {
    console.log('handled');
});
...
<div id="methods_once">
    ...
    <p></p>
    <pre class="code code-section"><code class="language-javascript">bodyManager.once('evnt', function () {
    console.log('handled');
});
bodyManager.dispatchEvent('evnt'); // logs "handled"
...
<div id="methods_parent">
    ...
    <pre class="code code-section"><code class="language-javascript">var parentOfBody = bodyManager.parent();
...
<div id="methods_pause">
    ...
    <pre class="code code-section"><code class="language-javascript">bodyManager.pause(); // triggers "paused" event
...
<div id="methods_play">
    ...
    <pre class="code code-section"><code class="language-javascript">bodyManager.play(); // triggers "playing" event
...
<div id="methods_prev">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.prev();</code></pre>
</div>
<div id="methods_prop">
...
<div id="methods_registerAs">
    ...
    <pre class="code code-section"><code class="language-javascript">newDivManager.registerAs('someother-div');</code></pre>
...
<div id="methods_registeredElementName">
    ...
    <pre class="code code-section"><code class="language-javascript">newDivManager.registerAs('someother-div');
...
<div id="methods_remove">
    ...
    <pre class="code code-section"><code class="language-javascript">newDivManager.remove();
...
<div id="methods_removeAttribute">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.removeAttribute('dataSome');</code></pre>
...
<div id="methods_removeValue">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.removeValue('dataSome', 'key');</code></pre>
    <pre class="code code-section"><code class="language-html">&lt;div data-some=&quot;attr&quot;&gt;&lt;/div&gt;</code></pre>
</div>
<div id="methods_sameOrigin">
    ...
    <pre class="code code-section"><code class="language-javascript">// this example is of code that is running inside of an unfriendly iframe
...
<div id="methods_setAddress">
    ...
    <pre class="code code-section"><code class="language-javascript">$.returnsManager(window).address; // xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx</code></pre>
</div>
<div id="methods_setAttribute">
    ...
    <pre class="code code-section"><code class="language-javascript">newDovManager.setAttribute('dataList', 'one two three four');</code></pre>
</div>
<div id="show">
    <h5 class="title-headline">#show</h5>
    <p>The show method is simply a convenience for setting display: block; on the element.</p>
    <pre class="code code-section"><code class="language-javascript">targetManager.show(); // &lt;div style=&quot;display&colon; block;&quot;&gt;&lt;/div&gt;</code></pre>
</div>
<div id="methods_siblings">
    ...
    <pre class="code code-section"><code class="language-javascript">var targetManager = $('div').index(10); // 11th element
...
<div id="methods_skip">
    ...
    <pre class="code code-section"><code class="language-javascript">targetManager.skip(2); // returns manager of element 2 siblings ahead
...
<pre class="code code-section"><code class="language-javascript">var newInput = $.createElement('input');
