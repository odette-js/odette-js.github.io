application.scope().run(function (app, _, factories) {
    ...
    marketingCardRegion.add([{
        ...
        content: 'It\'s <span data-custom="time-year"></span>. Why is there not an abstracted DOM layer yet? We have one. Enjoy custom behaviors tied to attributes, any event you can throw at it, custom event bubbling, and lifecycle control ahead of its time.'
    }, {
        link: '/api/v0/buster',
