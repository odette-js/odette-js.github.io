        ...
        var _ = app._,
            ...
            DomManager = factories.Events.extend(DOM_MANAGER_STRING, extend(classApi, {
                ...
                insertAt: function (els, index) {
                    var manager = this,
                        owner = manager.owner,
                        fragmentManager = isAppendable(els) ? owner.returnsManager(els) : DOMA(els).fragment(),
            ...
            DOMA = factories.Collection.extend('DOMA', extend(makeValueTarget(CLASS, CLASSNAME, propertyApi, BOOLEAN_TRUE), {
                /**
                 * @func
